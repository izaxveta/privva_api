...
RSpec.describe 'Issue API' do
  before(:each) do
    ...
    Issue.create(summary: 'Hello world', status: 0, reporter: @user_1, assignee: @user_2)
    Issue.create(summary: 'Hello world', status: 1, reporter: @user_2, assignee: @user_3)
    Issue.create(summary: 'Hello world', status: 1, reporter: @user_3, assignee: @user_1)
  end
